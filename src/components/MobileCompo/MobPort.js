...
export default function MobPort() {
  return (
    <div style={{ position: 'relative', padding: '5px', backgroundColor: '#3E3E3E', textAlign: 'center', overflow: 'hidden',marginTop:"10px" }}>
      {/* Watermark Logo */}
      <img
      ...
      <h2 style={{ fontSize: '32px', color: 'white', marginBottom: '30px' }}>Our Services</h2>
      <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'row', columnGap: '15px', overflow: 'hidden' }}>
        <div style={{ color: 'white', fontSize: '15px', textAlign: 'center', maxWidth: '400px' }}>
          <h3 style={{ color: '#FF5A5F', marginBottom: '20px' }}>Design Services</h3>
          <ul style={{ padding: 0, overflow: 'hidden',fontWeight:"600" }}>
