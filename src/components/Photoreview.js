    ...
    <div>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
           ...
           {/* //PhotoReview */}
           <div style={{display:"flex",justifyContent:"center",flexDirection:"row",columnGap:"100px",padding:"100px"}}>
           
        <div>
        <div><p style={{fontSize:"24px",fontWeight:"600",lineHeight:"3"}}>Modern Coastal Living Room and Bedroom Makeover</p></div>
        <div style={{display:"flex",flexDirection:"row",columnGap:"50px",justifyContent:"center",fontWeight:"500"}}>
            ...
            <img id="Image1Before" src="https://cdn.decorilla.com/images/1200x740/e1f2922e-b95b-487e-b3ca-6d0fb1010ffa/Modern-Coastal-Living-Room-and-Bedroom-Makeover-Rendering.jpg?cv=1" style={{height:"518px"}} />
        </div>
        ...
        <div class="carousel-item">
          ...
          <div style={{display:"flex",justifyContent:"center",flexDirection:"row",columnGap:"100px",padding:"100px"}}>
           ...
           <div style={{display:"flex",flexDirection:"row",columnGap:"50px",justifyContent:"center",fontWeight:"500"}}>
               ...
               <img src="https://cdn.decorilla.com/images/1200x740/e1f2922e-b95b-487e-b3ca-6d0fb1010ffa/Modern-Coastal-Living-Room-and-Bedroom-Makeover-Rendering.jpg?cv=1" style={{height:"518px"}} />
           </div>
           
           <div style={{textAlign:"center", display: "flex", flexDirection: "column",justifyContent:"center"}}>
               <div>
                 <p style={{fontSize:"19px",fontWeight:"500"}}>Clients Challenge</p>
                 <p>We would like a more minimal look with Feng Shui and natural elements that highlight our beautiful green view.</p>
               </div>
               <br></br>
               <div>
               <p style={{fontSize:"19px",fontWeight:"500"}}>Result</p>
               <blockquote>"We got the relaxing dream home we always wanted. Wanda was fun to work with and paid attention to every single detail."</blockquote>
               </div>
           </div>
          </div>
